...
26. Write a Python program to calculate the product, multiplying all the numbers in a 
    given tuple.
...
27. Write a Python program to calculate the average value of the numbers in a given tuple 
    of tuples.
...
32. Write a Python program to compute the sum of all the elements of each tuple stored 
