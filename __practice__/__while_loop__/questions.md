...
program_25. Write a python program to sum the sequence: 1 + 1/1! + 1/2! + 1/3! + …….. + 1/n!
...
program_30. Write a program to print the following series till n terms. 2 , 22 , 222 , 2222 _ _ _ _ _ n terms

program_31. Write a program to print the following series till n terms. 1 4 9 16 25 _ _ _ _ _ n terms.

program_32. Write a program to find the sum of the following series(accept values of x and n from user): 1 + x/1! + x2/2! + ……….xn/n!

program_33. Write a program to find the sum of following series: x + x2/2 + ……….xn/n

program_34. Write a program to find the sum of following series: 1 + 8 + 27 …………n terms

program_35. Write a program to find the sum of following series: 1 + 2 + 6 + 24 + 120 . . . . . n terms

program_36. Write a program to find the sum of following series: S = 1 + 4 – 9 + 16 – 25 + 36 – … … n terms

program_37. Write a Program to print all the characters in the string ‘PYTHON’ using a while loop.

program_38. Write a program to print only odd numbers from the given list using a while loop. L = [23,45, 32, 25, 46, 33, 71, 90]
...
program_51. Write a program to extract all the lower case character from the given string only if its ascii value is even

program_52. Write a program to get the following output

program_53. Write a program to get the following output
input=’hello’
output={0:’h’ , 1:’e’ , 2:’l’ , 3:’l’ , 4:’o’}

program_54. Write a program to get the following output
input=[‘hai’ , 89 ,3.4 , ‘hello’ , 90 , ‘py’]
output={‘hai’:’hi’ , ‘hello’:’ho’ , ‘py’:’py’}

program_55. Write a program to get the following output
input=‘hai hello’
output=’olleh iah’

program_56. Write a program to count the number of vowels present in a given string

program_57. Write a program to get the following output
input=‘hai hello good morning’
output={‘hai’:’a’ , ‘hello’: ‘l’ , ‘good’:’gd’ , ‘morning’:’n’}

program_58. Write a program to get the following output
input=[‘jiocinema.com’ , ’file.py’ , ‘web.html’]
output=[‘com’ , ’py’ , ‘html’]

program_59. Write a program to get the following output
input=[‘jiocinema.com’ , ’file.py’ , ‘web.html’ , ‘amazon.com’ , ‘text.py’]
output={‘com’:[‘jiocinema’ , ‘amazon’] , ’py’:[ ‘file’ , ‘text’] , ‘html’:[‘web’]}

program_60. Write a program to get the following output(count no of vowels)
input=’hai hello’
output={‘hai’:2 , ‘hello’:2}

program_61. Write a program to extract all the string values present in the list collection only if the last character is uppercase. Concatenate the extracted output using ‘*’

program_62. write a program to extract all the list data items present in list collection only if it is having
middle value , that value is integer and having even number at start

program_63. Write a program to get the following output
input= ‘just looking like wow’
output= ‘jusT LOOKING Like a wow’

program_64. Program to find the common elements in two sets using a while loop

program_65. Program to check if a number is a perfect number or not using while loop

program_66. Program to find the length of the longest substring without repeating characters in a given
string using while loop

program_67. Program to find the number of ways to make change for a given amount using a given set
of coins using while loop

program_68. Program to find the minimum number of coins needed to make a given amount using a
given set of coins using while loop

program_69. Program to find the maximum and minimum elements in a tuple using while loop

program_70. Program to find the union, intersection, and difference of two sets using while loop

program_71. Program to count the number of occurrences of each character in a string using a
dictionary and while loop

program_72. Write a program to remove duplicate value from collection without converting to set

program_73. Write a program to find the length of collection without using len function

program_74. Write a program to extract all the integers from a list only if the integer is starting from even number and ending as odd number and having length more than 3

program_75. Write a program to extract all the individual data items of a list if the length of extracted output is more than 4 print the first value of the output else print last value of the output list and add 10 to it

program_76. Write a program to get the following output

input1=’11001010’
input2=’01110010’
output=4(to count how many positions are having same value)

program_77. Write a program to get the following output
...
program_78. Write a program to check weather the given number is spy number or not i.e, 1*2*3=1+2+3

program_79. Write a program to check weather the given number is Xylem number or not i.e, 1234 → 1+4=2+3

program_80. Write a program to check weather the given number is phloem number or not i.e, 12345→ 1+5!=2+3+4

program_81. Write a program to check weather the given number is neon number or not i.e. 9 is number, 9**2=81→8+1=9

program_85. Write a program to check weather the given number is automorphic or not i.e.5 is number 5**2=25 last digit of 25 is the number itself

program_86. Write a program to count number of words in the given string

program_87. Write a program to find the length of the longest word

program_88. Write a program to count number of consonants in the given string

program_89. Write a program to check the type of data entered by the users

program_90. Write a program to check weather the given tuple is palindrome or not

program_91. Write a program to check weather the given collection is having nested collection or not

program_92. Write a program to return the positions of vowels present in the given string

program_93. Write a program to find length of collection without using len function

program_94. Write a program to whether the entered username and password is correct or not if not correct print enter again

program_95. Write a program to extract all integer data items from tuple
